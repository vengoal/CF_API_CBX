     **
     **  Program . . : CBX168V
     **  Description : Work with Data Queues  - VCP
     ...
     **
     ...
     D  PxLstOrd                     10a
      ...
      /Free
        ...
        If  %Scan( '*': PxDtqNam_q.ObjNam ) = *Zero;

          If  ChkObj( PxDtqNam_q: '*DTAQ' ) = *Off;

            SndDiagMsg( 'CPD0006'
                      : '0000' +
                        RtvMsg( 'CPF2105': PxDtqNam_q + 'DTAQ' )
                      );
